...
| 原生桌面窗口 | [PR #39](https://github.com/johnnyzhang-eng/career-workbench/pull/39) 把同一网页放入本机 macOS 浮动面板，验证图标、小窗、展开三种尺寸及实际运行画面。 | 跨应用首次点击、穿透与遮挡、全屏、多屏、长时资源和安装包均未完成实机验收；当前仍需手动启动本机服务。 |
| 原 3D 质感 | [PR #35](https://github.com/johnnyzhang-eng/career-workbench/pull/35) 保留用户较认可的 A 光影并逐项试环境光、主光角度、镜头、单件 Blender 桌面和原创可编辑角色。 | 小窗人物仍很小；电脑坐姿只是静态姿态，骨骼权重、连续打字、阅读与休息动作和材质统一还待做。不能凭资产数量宣布“精修 3D 已过门槛”。 |

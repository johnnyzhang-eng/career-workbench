...
状态：2026-09-24，仅研究与待讨论方案；**暂停新实现，所有下述试验和素材采用均待用户讨论**。本轮未下载资产、购买素材或调用收费API。用户明确认为A的光影/真实感优于B、B仍粗糙；D只是降采样等距研究，不能代表像素路线。原视频真实画面与屏上要求见[关键帧复核](REFERENCE_FRAME_RECHECK.md)，未完整转录所有提示词；本文件不使用ASR推断原视频要求。
...
本文件提供可执行调查方案与许可线索，尚无新方案的运行证据。原视频关键帧复核已另记，未核验部分仍不得纳入确定需求。

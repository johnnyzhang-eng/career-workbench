...
新增角色、房间和 UI 实现已暂停，须先与用户讨论。见 [本轮研究](ROUND2_RESEARCH.md)：A/B 的光照、投影和几何差异是源码支持的机制线索，尚未通过单因素实验确认各因素贡献；许可候选均未下载或采用。原参考视频已完成[关键帧复核](REFERENCE_FRAME_RECHECK.md)，明确区分直接画面、意译与尚未核验的全文；不把旧观看摘要或 ASR 当成新证据。
